...
DATA_DOWNLOAD_URL = 'https://www.dropbox.com/s/ws9o25cfc4znvc7/us_northeast_osm.bin?dl=0'

BINARY_PATH = park.__path__[0] + '/envs/multi_dim_index/exec/mdi_db'
BINARY_DOWNLOAD_URL = 'https://www.dropbox.com/s/51avyp7zposqcde/mdi_db?dl=0'
